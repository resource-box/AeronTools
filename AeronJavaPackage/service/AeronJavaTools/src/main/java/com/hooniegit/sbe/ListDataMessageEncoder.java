...
public final class ListDataMessageEncoder
{
    ...
    public ListDataMessageEncoder putTimestamp(final DirectBuffer src, final int srcOffset, final int length)
    {
    ...
    public ListDataMessageEncoder putTimestamp(final byte[] src, final int srcOffset, final int length)
    {
        if (length > 1073741824)
        {
            throw new IllegalStateException("length > maxValue for type: " + length);
    ...
    public ListDataMessageEncoder timestamp(final String value)
    {
