...
namespace Com.Hooniegit.Sbe
{
    ...
    /// 리스트 형태 메시지
    /// </summary>
    public sealed partial class ListDataMessage
    {
        ...
        private readonly ListDataMessage _parentMessage;
        ...
        public ListDataMessage()
        {
            _parentMessage = this;
        }

        public ListDataMessage WrapForEncode(DirectBuffer buffer, int offset)
        {
            _buffer = buffer;
            _offset = offset;
        ...
        public ListDataMessage WrapForEncodeAndApplyHeader(DirectBuffer buffer, int offset, MessageHeader headerEncoder)
        {
        ...
        public ListDataMessage WrapForDecode(DirectBuffer buffer, int offset, int actingBlockLength, int actingVersion)
        {
            _buffer = buffer;
            _offset = offset;
        ...
        public ListDataMessage WrapForDecodeAndApplyHeader(DirectBuffer buffer, int offset, MessageHeader headerDecoder)
        {
        ...
        public sealed partial class EntriesGroup
        {
            ...
            private ListDataMessage _parentMessage;
            private DirectBuffer _buffer;
            ...
            public void WrapForDecode(ListDataMessage parentMessage, DirectBuffer buffer, int actingVersion)
            {
            ...
            public void WrapForEncode(ListDataMessage parentMessage, DirectBuffer buffer, int count)
            {
                if ((uint) count > 65534)
                {
        ...
        public const int TimestampId = 4;
        ...
        internal void BuildString(StringBuilder builder)
        {
            ...
            builder.Append(ListDataMessage.TemplateId);
            builder.Append("|sbeSchemaId=");
            builder.Append(ListDataMessage.SchemaId);
            builder.Append("|sbeSchemaVersion=");
            if (_parentMessage._actingVersion != ListDataMessage.SchemaVersion)
            {
                builder.Append(_parentMessage._actingVersion);
                builder.Append('/');
            }
            builder.Append(ListDataMessage.SchemaVersion);
            builder.Append("|sbeBlockLength=");
            if (_actingBlockLength != ListDataMessage.BlockLength)
            {
                builder.Append(_actingBlockLength);
                builder.Append('/');
            }
            builder.Append(ListDataMessage.BlockLength);
            builder.Append("):");
